...
-- Generation Time: Sep 08, 2024 at 10:05 AM
...
--
-- Database: `if0_37226912_jaya_hospital`
--
...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `phone_number`, `age`, `mykad`, `address`, `insurance`, `allergies`, `gender`, `emergency_contact_name`, `emergency_contact_relationship`, `emergency_contact_phone`, `date_of_birth`, `medical_history`, `consent_for_information_sharing`) VALUES
(1, 'Teh Tze Ken', 'tzekeneci@gmail.com', 'kenkenken', '0173925380', 16, '69420', 'Sesame Street', 'AIA', 'Lactose Intolerance', 'Male', 'John Doe', 'Friend', '999', '2008-10-17', 'Monkeypox', 1),
(2, 'John Doe', 'john.doe@example.com', 'password123', '0123456789', 35, '901225-14-1234', '123 Main St, City, State, 12345', 'Company A', 'None', 'Male', 'Jane Doe', 'Spouse', '0198765432', '1989-12-25', 'Regular Checkups', 1),
(3, 'Emily Smith', 'emily.smith@example.com', 'password456', '0987654321', 28, '950315-06-5678', '456 Elm St, Town, Region, 67890', 'Company B', 'Penicillin', 'Female', 'Michael Smith', 'Brother', '0176543210', '1995-03-15', 'Asthma Treatment', 1),
(4, 'Terrence Lim', 'bricksworldworld@gmail.com', '131400BC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
